...
UPLOAD_DIRECTORY = "."
TEMP_DIRECTORY = "leadme/video/temporary"  # 임시 저장 디렉토리 경로
PERMANENT_DIRECTORY_USER = "leadme/video/user"  # 영구 저장 디렉토리 경로
PERMANENT_DIRECTORY_CHALLENGE = "leadme/video/challenge"  # 영구 저장 디렉토리 경로
